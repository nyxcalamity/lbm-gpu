 ...
 */
extern __device__ void ComputeDensityGpu(float *current_cell, float *density);


/**
 * Computes the velocity within currentCell and stores the result in velocity
 */
extern __device__ void ComputeVelocityGpu(float *current_cell, float *density, float *velocity);
 ...
 */
extern __device__ void ComputeFeqGpu(float *density, float *velocity, float *feq);
